...
<html lang="en">
  <head>
    <!--  Title -->
    <title>Power Line Solutions Branch</title>
    <!--  Required Meta Tag -->
        ...
        <div>
          <div class="brand-logo d-flex align-items-center justify-content-between">
            <a href="branch-index" class="text-nowrap logo-img">
              <img src="assets/images/logo/logo.png" class="dark-logo" width="180" alt="" />
              <img src="assets/images/logo/logo.png" class="light-logo"  width="180" alt="" />
            </a>
